export default {
    accounts: {
      ...
      openai: {
        ...
        codexToolLoopInjection: 'Codex Tool-loop 注入（实验）',
        codexToolLoopInjectionDesc: '按原 PoC 逻辑：当 input 最后一项是 user message 时，追加一组 exec custom_tool_call 与匹配的 custom_tool_call_output。默认关闭。',
