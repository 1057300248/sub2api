      ...
      >
        ...
        <div class="mt-4 flex items-center justify-between gap-4 border-t border-gray-200 pt-4 dark:border-dark-600">
          ...
          <Toggle
            ...
            data-testid="edit-codex-tool-loop-injection-toggle"
...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  if (newAccount.platform === 'openai' && (newAccount.type === 'oauth' || newAccount.type === 'setup-token' || newAccount.type === 'apikey')) {
    ...
    if (newAccount.type === 'oauth') {
      codexToolLoopInjectionEnabled.value = extra?.codex_tool_loop_injection_enabled === true
    ...
    if (props.account.platform === 'openai' && (props.account.type === 'oauth' || props.account.type === 'setup-token' || props.account.type === 'apikey')) {
      ...
      if (props.account.type === 'oauth') {
        ...
        if (codexToolLoopInjectionEnabled.value) {
          newExtra.codex_tool_loop_injection_enabled = true
        } else {
          delete newExtra.codex_tool_loop_injection_enabled
        }
      }
